...
const available_examples = [_]Example{
    ...
    .{ .target = rp2xxx.boards.raspberrypi.pico, .name = "pico_i2c-bus-scan", .file = "src/i2c_bus_scan.zig" },
    .{ .target = rp2xxx.boards.raspberrypi.pico, .name = "pico_pwm", .file = "src/pwm.zig" },
    .{ .target = rp2xxx.boards.raspberrypi.pico, .name = "pico_random", .file = "src/random.zig" },
    .{ .target = rp2xxx.boards.raspberrypi.pico, .name = "pico_spi-master", .file = "src/spi_master.zig" },
    .{ .target = rp2xxx.boards.raspberrypi.pico, .name = "pico_squarewave", .file = "src/squarewave.zig" },
    .{ .target = rp2xxx.boards.raspberrypi.pico, .name = "pico_uart", .file = "src/uart.zig" },
    .{ .target = rp2xxx.boards.raspberrypi.pico, .name = "pico_usb-hid", .file = "src/usb_hid.zig" },
